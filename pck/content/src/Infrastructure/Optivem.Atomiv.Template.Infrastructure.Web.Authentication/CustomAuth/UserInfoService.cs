    ...
    public class UserInfoService : IUserInfoService
    {
        private static readonly Dictionary<string, UserInfo> Map = new Dictionary<string, UserInfo>
        {
            { "bde2080b-c50a-4ed6-a9b0-9a33ccdb1ab7", 
                new UserInfo(Guid.NewGuid(), "john.smith@acme.com", "en", "01-1234-5678", new RoleType[] { RoleType.Customer }, new RequestType[] { RequestType.CreateCustomer } ) },
            { "e3454f87-c586-411d-a36d-8575a95dc80e", 
                new UserInfo(Guid.NewGuid(), "mary.mcdonald@acme.com", "en", "02-1234-5678", new RoleType[] { RoleType.Customer }, new RequestType[] { RequestType.CreateCustomer } ) },
            { "d021c726-0f2b-498f-9850-83c0b0f89ae3", 
                new UserInfo(Guid.NewGuid(), "tom.brown@acme.com", "en", "03-1234-5678", new RoleType[] { RoleType.Customer }, new RequestType[] { RequestType.CreateCustomer } ) },
        };
