...
using Optivem.Atomiv.Template.Core.Application.Products;
using Optivem.Atomiv.Template.Core.Application.Products.Requests;
using Optivem.Atomiv.Template.Core.Application.Products.Responses;
using Optivem.Atomiv.Template.Web.RestClient.Interface;
using System.Threading.Tasks;

namespace Optivem.Atomiv.Template.Web.UI.Services.Application
{
