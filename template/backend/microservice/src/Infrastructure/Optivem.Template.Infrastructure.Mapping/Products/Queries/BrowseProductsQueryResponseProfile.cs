...
{
    public class BrowseProductsQueryResponseProfile : Profile
    {
        public BrowseProductsQueryResponseProfile()
        {
            CreateMap<PageReadModel<ProductHeaderReadModel>, BrowseProductsQueryResponse>()
