...
{
    public class UnlistProductUseCase : IRequestHandler<UnlistProductRequest, ProductResponse>
    {
        ...
        public async Task<ProductResponse> HandleAsync(UnlistProductRequest request)
        {
