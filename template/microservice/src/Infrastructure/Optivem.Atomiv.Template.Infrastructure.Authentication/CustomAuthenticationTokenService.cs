...
namespace Optivem.Atomiv.Template.Infrastructure.Authentication
{
    public class CustomAuthenticationTokenService : ICustomAuthenticationTokenService
    {
        ...
        {
            { "bde2080b-c50a-4ed6-a9b0-9a33ccdb1ab7", new CustomAuthenticationUserInfo { Email = "john.smith@acme.com" } },
            { "e3454f87-c586-411d-a36d-8575a95dc80e", new CustomAuthenticationUserInfo { Email = "mary.mcdonald@acme.com" } },
            { "d021c726-0f2b-498f-9850-83c0b0f89ae3", new CustomAuthenticationUserInfo { Email = "tom.brown@acme.com" } },
        };
