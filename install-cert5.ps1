...
$pfxFilePath = "C:\projects\framework-dotnetcore\template\src\Web\Optivem.Template.Web.UI\localhost3.pfx"
$cerFilePath = "C:\projects\framework-dotnetcore\template\src\Web\Optivem.Template.Web.UI\localhost3.cer"
